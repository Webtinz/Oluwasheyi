...
const Home = () => {
    ...
    // console.log("List of contents: ", contents);
                ...
                <div className="container pt-4">
                    <div className="row">
                        <div className="col-lg-7 mx-auto order-2 order-lg-1">
                            <div>
                                <img src={contents?.data.home_page_patient_portal_bg_img.image} alt="" className="img-fluid w-100" />
                            </div>
                        </div>
                        <div className="col-lg-4 mb-3 mx-auto align-self-center order-1 order-lg-2" style={{ padding: "0px" }}>
                            <div className="p-3" style={{ fontWeight: "600" }}>
                                <h1 className="text-white text-uppercase fw-bold text-center text-md-start" style={{ fontSize: '35px', margin: "20px 0" }}>{selectedLanguage === 'fr' ? contents?.data.home_page_banner_link4.content_fr : contents?.data.home_page_banner_link4.content_en}</h1>
                                <div className="mt-3 text-white text-uppercase  text-center text-md-start">
                                    {selectedLanguage === 'fr' ? (<div dangerouslySetInnerHTML={{
                                        __html: contents?.data.home_page_patient_portal_desc.content_fr
                                    }} />) : (<div dangerouslySetInnerHTML={{
                                        __html: contents?.data.home_page_patient_portal_desc.content_en
                                    }} />)}
                                </div>
