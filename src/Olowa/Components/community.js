                ...
                <>
                  <div
                    ...
                    <div className="position-relative">
                      <img loading="lazy" src={item.image} alt="community" className="image-fluid w-100 main-img1" style={{ borderRadius: item.borderRadius, objectFit: 'cover' }} />
                      <div className={item.positionClass}>
                        <img loading='lazy' src={Lg} alt="" style={{ width: "80%" }} />
                      </div>
                    </div>
                  </div>
                  <div
                    ...
                    <div className="p-2 p-lg-4">
                      ...
                      <div className="mt-4">
                        ...
                        >
                          {selectedLanguage === 'fr' ? contents?.data.home_page_welcome_button.content_fr : contents?.data.home_page_welcome_button.content_en}
                        </Link>
                      </div>
                    </div>
                  </div>
