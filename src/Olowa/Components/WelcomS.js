  ...
  return (
    <section className="mt-4 container">
      <div className="row">
        ...
        <div className="col-lg-6 mb-3 mx-auto align-self-center p-5">
          <div className="p-4 trt">
            <h2 className="mt-3 section-title" style={{fontSize:'30px'}}>
              Welcome to Clinique Polyvalente OLUWA SHEYI
            </h2>
            <br/>
            ...
            <div className="mt-3">
              <button className="btn btn-w px-4 toggle-button" onClick={toggleContent}>
